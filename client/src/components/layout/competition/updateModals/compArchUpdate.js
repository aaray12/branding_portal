...
function CompArchUpdate(props) {
    const [formObject, setFormObject] = React.useState({})
    const [archObject, setArchObject] = React.useState({archs: props.compArchs})
    ...
    return(
        ...
        <Modal.Header closeButton>
            <Modal.Title id="contained-modal-title-vcenter">
                {props.rank} Competitor Archetypes
            </Modal.Title>
        </Modal.Header>
        <Modal.Body>
            <Form>
